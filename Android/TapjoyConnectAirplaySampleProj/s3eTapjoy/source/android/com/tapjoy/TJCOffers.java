...
public class TJCOffers
{
	...
	public void showOffers()
	{
		...
		offersIntent.putExtra(TapjoyConstants.EXTRA_CLIENT_PACKAGE, TapjoyConnectCore.getClientPackage());
	...
	public void showOffersWithCurrencyID(String currencyID, boolean enableCurrencySelector)
	{
		...
		offersURLParams += "&" + TapjoyConstants.TJC_MULTIPLE_CURRENCY_ID + "=" + multipleCurrencyID;
	...
	private boolean handleGetPointsResponse(String response)
	{
		...
		if (document != null)
		{
			...
			if (nodeValue != null && nodeValue.equals("true"))
			{
				...
				{
//					pointTotal = Integer.parseInt(points);
//					currencyName = name;
