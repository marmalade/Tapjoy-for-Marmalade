...
public class TapjoyFeaturedApp
{
	...
	public void getFeaturedApp(TapjoyFeaturedAppNotifier notifier)
	{
		...
		// Add the default userID to the URL parameters.
	 ...
	 * @param notifier				Class which receives callback with Featured App data.
	 */
	public void getFeaturedApp(String currencyID, TapjoyFeaturedAppNotifier notifier)
	{
		...
		// Add the currency and userID parameters to our URL parameters.
		String featuredAppURLParams = TapjoyConnectCore.getURLParams();
		featuredAppURLParams += "&" + TapjoyConstants.TJC_USER_ID + "=" + TapjoyConnectCore.getUserID();
		featuredAppURLParams += "&" + TapjoyConstants.TJC_MULTIPLE_CURRENCY_ID + "=" + currencyID;
		
//		GetFeaturedAppDataTask getFeaturedAppDataTask = new GetFeaturedAppDataTask();
//		getFeaturedAppDataTask.execute();
	...
	public void showFeaturedAppFullScreenAd()
	{
		...
		if (fullscreenURL.length() != 0)
		{
			...
			featuredAppIntent.putExtra(TapjoyConstants.EXTRA_URL_PARAMS, TapjoyConnectCore.getURLParams());
			featuredAppIntent.putExtra(TapjoyConstants.EXTRA_FEATURED_APP_FULLSCREEN_AD_URL, fullscreenURL);
			featuredAppIntent.putExtra(TapjoyConstants.EXTRA_CLIENT_PACKAGE, TapjoyConnectCore.getClientPackage());
...
//	 */
//	private class GetFeaturedAppDataTask extends AsyncTask<Void, Void, Boolean>
//	{
//		@Override
...
//			boolean returnValue = false;
//			
//			String response = tapjoyURLConnection.connectToURL(TapjoyConstants.TJC_SERVICE_URL + TapjoyConstants.TJC_FEATURED_APP_URL_PATH, featuredAppURLParams);
//			
//			if (response != null)
//			{
//				returnValue = buildResponse(response);
