...
@interface TJCUserAccountManager : NSObject <TJCFetchResponseDelegate>
{
	...
	TJCUserAccountRequestHandler *userAccountReqHandlerObj_;	/*!< The handler object is in charge of initiating the URL request for getting the user data from the server. */
